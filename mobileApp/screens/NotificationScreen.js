      ...
      {postVisible ? (
        ...
        <View>
          {notifications.length == 0 ? (
            <Text
              style={[styles.MainText, { fontSize: 16, marginVertical: 25 }]}
            >
      ...
      {dmList.length == 0 ? (
        <View>
          <Text
            style={[
              styles.MainText,
              { fontSize: 16, marginVertical: 25, textAlign: "center" },
            ]}
          >
            {"You haven't created any chats."}
          </Text>
          <Text
            style={[
              styles.MainText,
              { fontSize: 16, color: "#A57FC1", textAlign: "center" },
            ]}
          >
            {
              "Create a chat with the button below or in\na user's profile page."
            }
          </Text>
        </View>
      ) : (
